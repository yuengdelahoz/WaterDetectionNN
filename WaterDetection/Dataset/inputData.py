	...
	def next_batch(self, batch_size):
		...
		for img in imgs:
			if img.endswith('.jpg'):
				...
				edgeImg = cv2.imread(self.path+'/EDGES/'+img,cv2.IMREAD_GRAYSCALE) # We want 0 and 255 because the other RGB layers work with these values and the train function normalizes the whole input set
